...
SIZE = 40  # The size of each block
SCREEN_WIDTH = 1000
SCREEN_HEIGHT = 800
BACKGROUND_COLOUR = (87, 108, 67)
...
class Apple:
    ...
    def move(self):
        # Restrict the apple position within the screen bounds
...
class Snake:
    def __init__(self, parent_screen):
        self.parent_screen = parent_screen
        self.image = pygame.image.load("Resources/yellow-square.jpg").convert()
        self.image = pygame.transform.scale(self.image, (40, 40))
        self.direction = 'down'
    ...
    def walk(self):
        ...
        # Check for collision with screen boundaries (game over)
...
class Game:
    ...
    def play(self):
        ...
        # Snake colliding with itself (starts checking from length 4)
